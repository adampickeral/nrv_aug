  ...
  '<div class="blurbs">' +
    '<div class="blurb">' +
      '<blog>' +
        ...
        '<date>6/11/13</date>' +
        '<section>' +
          '<p class="blurb-content">This was our first meeting trying out the Lean Coffee format, and I\'d say it went pretty well. Everyone had a lot of interesting topics to discuss, and we had a lot of insightful discussion on the topics we chose to discuss.</p>' +
        '</section>' +
        '<section>' +
          ...
          '<p class="blurb-content">If your team is full of clean coders and clean code is something they are passionate about, watching the Clean Coders video series together as a team is another excellent way to show off your team\'s values. The important part here is that everyone watches these together as a team, not just the new members.</p>' +
          '<p class="blurb-content">So when you want to teach new members how your team works, just use the process, and get the whole team involved.</p>' +
        '</section>' +
        '<section>' +
          '<h3>Scaling Continuous Integration / Deployment</h3>' +
          '<p class="first">Reliable continous deployment can be difficult to achieve, but once your team reaches it, it is an excellent practice to maintain. It is much easier to get to continous deployment with a small team, but how do you scale it as the team grows?</p>' +
          ...
          '<p class="blurb-content">Queueing can be done in a couple of different ways. Usually you won\'t have a single team of ~20 developers, rather you will have multiple sub-teams of 3-5 developers. In this case, you can have a queue within each team. Having a physical token that team member\'s need to have in their possesion on order to merge and deploy is a great tool for enforcing the queue.</p>' +
          '<p class="blurb-content">Queues within each team helps, but it only gets you down to at most having the total number of sub-teams trying to merge and deploy at once. So what is needed then is a singel queue for everyone involved. There can be ways to automate a queue in a build system, but the first step should be implementing a manual process. Something lightweight that\'s easy to implement and test. Then you can automate it if it\'s working. The queue will also magnify any pain points in the deployment pipeline, as team members will have to wait longer to merge and deploy their code. This is a good thing! It will cause the team to make the process faster and fix instabilities.</p>' +
        '</section>' +
        '<section>' +
          '<h3>Planning Research Work (Spikes)</h3>' +
          '<p class="first">Sometimes we don\'t fully understand what changes need to be made for new functionality, or we don\'t know the feasability of proposed new functionality. In these cases the team needs to perform spikes to better understand the new functionality before they can do any planning around it. The problem is, how do you keep these spikes from eating up all of your development time?</p>' +
          '<p class="blurb-content">The simplest solution is to timebox spikes. Setting a fixed limit on a spike is a way to ensure we do the minimal amount of research necessary in order to better plan the upcoming work. We don\'t need to know how to implement it, we just need to is it possible and what is the scope of the work.</p>' +
          '<p class="blurb-content">Sometimes these spikes are large and can\'t be contained within a small timebox. This is really a symptom of a spike that is too vague. Just like a user story, a spike needs to have acceptance criteria, or some measurable goals that team members can check off so they know when they are done with a spike. Spikes can also be broken down into smaller spikes. If the scope of a spike will take longer than 2 days to investigate, split it into smaller spikes that make sense. Remember that we work in small increments, and this applies to almost everything we do, including research.</p>' +
        '</section>' +
      '</blog>' +
    '</div>' +
  '</div>';
