    ...
    if (challengeAccepted(req.session.cq, requestBody.picture)) {
      options = {
        ...
        form: {
          ...
          text: 'Thanks for RSVP\'ing to the meeting on Tuesday November 12th, 2013, at 6:00pm. Your reply: ' + requestBody.reply + '. To change your reply, simply resubmit the form on the site.'
        }
      };
